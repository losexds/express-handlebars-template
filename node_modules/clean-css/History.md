...
* Speed improvements up to 4x thanks to the rewrite of comments and CSS' content
  processing.
* Stripping empty CSS tags is now optional (see [bin/cleancss](/express-handlebars-template/bin/cleancss) for details).
...
* Fixed tests, [package.json](/express-handlebars-template/package.jsonlebars-template/package.json) for development, and regex
...
* Updated repository location and author information in [package.json](/express-handlebars-template/package.jsonlebars-template/package.json).
